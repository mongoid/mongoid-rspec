...
* [#216](https://github.com/mongoid/mongoid-rspec/pull/216): Added support for calling methods with allowed values to `inclusion_of` - [@maciejmajewski](http://github.com/maciejmajewski).
